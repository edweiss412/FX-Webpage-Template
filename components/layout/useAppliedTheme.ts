...
export type AppliedTheme =
  | { mounted: false; theme: "light"; isDark: false; setTheme: (next: Theme) => void }
  | { mounted: true; theme: Theme; isDark: boolean; setTheme: (next: Theme) => void };
...
export function useAppliedTheme(): AppliedTheme {
  ...
  return state.mounted
    ? { mounted: true, theme: state.theme, isDark: state.theme === "dark", setTheme }
