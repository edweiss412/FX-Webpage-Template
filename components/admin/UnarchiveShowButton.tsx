...
function SubmitButton({
  ...
  return (
    <button
      ...
      disabled={pending}
      aria-busy={pending}
      className="inline-flex min-h-tap-min items-center justify-center self-center rounded-sm border border-text-faint bg-surface px-3 py-1.5 text-sm font-medium text-text-strong transition-colors duration-fast hover:bg-surface-sunken focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-surface"
    >
