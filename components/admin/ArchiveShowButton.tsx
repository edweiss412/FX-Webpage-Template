          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex min-h-tap-min min-w-tap-min items-center justify-center rounded-sm border border-text-faint bg-surface px-4 py-2 text-sm text-text transition-colors duration-fast hover:bg-surface-sunken focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring disabled:cursor-not-allowed disabled:opacity-60"
              >
                Cancel
              </button>
            </div>
