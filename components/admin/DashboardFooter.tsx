 ...
 *   - Visible text: "New here? →"
 *
 * The "New here?" prompt IS the affordance — the previously separate
 * "Take the tour →" link was redundant with it, so the prompt itself now
 * links to the walkthrough.
 *
 * Phase G.3 supersedes M10's in-product `<Tour />` modal (Tour.tsx deleted).
 * The /help/tour MDX page (Phase E.12) is the canonical walkthrough; the
 * dashboard footer routes Doug to it directly via this link, in line with
 * the §5.6 template-family pattern of "section affordance → /help deep link."
 *
 * Server Component.
 */
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="inline-flex w-fit min-h-tap-min items-center justify-center rounded-sm text-sm font-medium text-accent-on-bg underline underline-offset-4 transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
      >
        New here? →
      </Link>
