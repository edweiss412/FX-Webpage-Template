...
const CONTROL = cn(
  "min-h-tap-min rounded-md border border-text-faint bg-surface px-3 text-xs text-text-strong focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:outline-none",
);
const BUTTON = cn(
