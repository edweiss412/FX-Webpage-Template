...
// Wayfinding link (impeccable critique P1 — alert-copy full-sweep): routes to
// the code's longform /help/errors education. It RESTS at `text-text` as of
// 2026-08-14 — the subtle-on-interactive policy (DESIGN §1.1a) retired
// `text-text-subtle` as a resting colour for action targets, and this link is
// one. It still does not compete with LINK_CTA: that separation is carried by
// HUE (the CTA is accent) and by the underline arriving only on hover/focus,
// not by dimming the link below body weight. Keeps the 44px tap floor.
const HELP_LINK = cn(
        ...
        <div className="flex items-center justify-between gap-3 px-4 pb-2.5 pt-4 sm:px-5 sm:pt-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="-mr-1 inline-flex size-tap-min items-center justify-center rounded-sm text-text transition-colors duration-fast hover:bg-surface-sunken hover:text-text-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
            >
