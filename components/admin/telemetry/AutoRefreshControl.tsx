  ...
  return (
    <div className="inline-flex flex-wrap items-center gap-x-3 gap-y-1 rounded-md border border-border bg-surface px-3 py-1.5 shadow-tile">
      ...
      <button
        ...
        onClick={doRefresh}
        className="inline-flex min-h-tap-min min-w-tap-min items-center justify-center rounded-sm border border-text-faint p-1.5 text-text hover:bg-surface-sunken hover:text-text-strong"
      >
