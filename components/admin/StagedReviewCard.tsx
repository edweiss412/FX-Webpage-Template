          ...
          {isFirstSeenMode ? (
            ...
            >
              ...
              <a
                ...
                className="mt-2 inline-flex w-fit min-h-tap-min items-center text-sm font-medium text-accent-on-bg underline underline-offset-2 transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-surface-sunken"
              >
                Learn more →
              </a>
            </HelpTooltip>
      ...
      {!readOnly && (
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <button
            ...
            aria-busy={pending}
            className="min-h-tap-min rounded-sm border border-text-faint bg-surface px-4 py-2 font-medium text-text-strong transition-colors duration-fast hover:bg-surface-sunken focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-surface-raised disabled:cursor-not-allowed disabled:opacity-60"
          >
            Retry on next sync
          </button>
          {isFirstSeen ? (
