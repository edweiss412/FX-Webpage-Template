      ...
      {docs.map((link) => {
        ...
        return (
          <button
            ...
            className="inline-flex min-h-tap-min items-center gap-2 self-start rounded-sm border border-text-faint bg-surface-raised px-3 py-2 text-sm font-medium text-text-strong shadow-tile hover:border-border-strong focus:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
