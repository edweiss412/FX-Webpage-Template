    ...
    <div data-testid="identity-chip" className="flex flex-col items-end gap-0.5 text-right">
      ...
      <form action={clearIdentityFormAction}>
        ...
        <button
          ...
          className="min-h-tap-min text-xs text-accent-on-bg underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2"
        >
          Not you?
        </button>
      </form>
