...
/**
 * app/admin/error.tsx (M12.2 B1 Task 2.1)
 *
 * Catch-all client error boundary for every /admin/* segment without a
 * closer error.tsx (§2.7 topology). Renders the FIXED
 * ADMIN_ROUTE_LOAD_FAILED Doug copy — NOT err.code: error.tsx files are
 * client components and Next serializes thrown errors as
 * Error & { digest }, so a thrown `.code` is unreliable in production.
 *
    ...
    <main className="mx-auto max-w-2xl px-tile-pad pb-section-gap">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            href="/admin"
            data-testid="admin-route-error-back"
