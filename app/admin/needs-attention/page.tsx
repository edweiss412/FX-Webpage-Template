    ...
    <div data-testid="admin-needs-attention-page" className="flex w-full flex-col gap-section-gap">
      <AdminPageHeader
        ...
        titleAppendSlot={
          ...
          >
            <p>
              Everything waiting on a decision from you: sheets we could not auto-apply, staged
              changes to review, and held crew identity changes. Items leave this list as soon as
              you resolve them.
            </p>
          </HoverHelp>
        }
