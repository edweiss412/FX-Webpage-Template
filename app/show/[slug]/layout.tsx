 ...
 * the framework font loader itself (the app moved off it entirely later, in
 * `BL-INTER-NUMERAL-DISAMBIGUATION`), which bound the DESIGN.md §2.1 family for the
 * crew subtree ONLY — every other tree (admin, auth, help) rendered the
 * system fallback. The face now lives in `app/fonts.css`, imported by both
