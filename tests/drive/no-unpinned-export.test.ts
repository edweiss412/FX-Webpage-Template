...
const scanRoots = ["lib/sync", "app/api/cron", "app/api/drive", "app/api/admin"] as const;
...
describe("M6 same-revision export binding guard", () => {
  test("production API and sync surfaces do not call unpinned fetchSheetAsMarkdown()", () => {
