...
/** 30 — sheet-data-quality gaps counted by summarizeDataGaps (from GAP_CLASSES). */
...
/** The full persisted-ParseWarning universe (50) — every code lands in exactly one bucket. */
...
describe("data-gap class completeness (drift guard)", () => {
  it("Layer 1 — the 4 buckets are pairwise disjoint and total 50 (30/7/2/11)", () => {
    ...
    expect(ALL_PERSISTED_WARNING_CODES.size).toBe(50); // Set dedups → proves pairwise-disjoint
