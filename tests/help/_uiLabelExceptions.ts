...
export const DECLARED_UI_LABELS: readonly DeclaredUiLabel[] = [
  ...
  },
  {
    ...
    file: "app/help/admin/dashboard/page.mdx",
    note: "Pending-panel discard action — components/admin/PendingPanelDiscardButtons.tsx, testid admin-pending-defer-*.",
  },
  {
    label: "Permanently ignore",
    file: "app/help/admin/dashboard/page.mdx",
    note: "Pending-panel discard action — components/admin/PendingPanelDiscardButtons.tsx, testid admin-pending-ignore-*.",
  },
