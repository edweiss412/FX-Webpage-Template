...
const LOCAL_ONLY_ALLOWLIST: Record<string, string> = {
  ...
  "tests/e2e/help-tour-layout-dimensions.spec.ts":
    "runs in help-affordances.yml through the project-only invocation at .github/workflows/help-affordances.yml:97 (--project=help-docs-setup --project=help-docs --project=help-docs-desktop), which the scanner cannot see by its own contract. That workflow carries a PATH-FILTERED pull_request trigger over the surfaces it guards (:3 ff., including tests/e2e/** and, as of this arc, app/globals.css). Not PR-blocking-capable: the job is absent on non-matching PRs, and help-affordances is not among the required contexts. It resolves 5 cases under help-docs-desktop. Added by fix/help-tour-grid-and-settings-card, which asserts the /help tour card grids' real-browser column sequences and measure floor.",
