...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "statement-removal:842:5:DIGIT_RUN_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in templateCandidates",
      },
      {
        siteId: "statement-removal:898:5:LEXICON.lastIndex = 0;>(removed)",
        kind: "equivalent",
      ...
      {
        siteId: "integer-literal:959:30:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:890:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:989:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1040:21:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:896:40:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:997:40:1>2",
        kind: "equivalent",
        reason: "same opening-backtick argument for the shape (b) span ranges",
      },
      {
        siteId: "integer-literal:997:59:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId:
          "statement-removal:929:3:mismatches.sort((a, b) => a.first.docLine - b.first.docLine || a.first.column - b.first.column);>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:863:24:0>1",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1073:61:<><=",
        kind: "equivalent",
        reason:
