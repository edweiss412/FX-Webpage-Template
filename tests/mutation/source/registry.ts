...
export const GUARD_SURFACES: GuardSurface[] = [
  ...
  /**
   * The three prose-count parity arms (spec
   * `docs/superpowers/specs/2026-08-10-speclint-prose-count-parity.md`, AC-4).
   *
   * Enrolment PRECEDES review here, per AGENTS.md: the subject is a recognizer
   * whose defect class is "reports OK while the output moved", which is exactly
   * what the registry can express, so the convergence criterion for its diff
   * review is the score plus an empty unaccepted-survivor set rather than an
   * open enumeration of inputs that might escape.
   */
  {
    id: "specLintNumerics",
    ...
    accepted: [
      ...
      {
        siteId: "statement-removal:661:3:CARDINAL_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in cardinalsOn",
      },
      {
        siteId: "statement-removal:766:5:DIGIT_RUN_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in templateCandidates",
      },
      {
        siteId: "statement-removal:822:5:LEXICON.lastIndex = 0;>(removed)",
        kind: "equivalent",
      ...
      {
        siteId: "integer-literal:609:28:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: 'statement-removal:441:7:lastWord = "";>(removed)',
        kind: "equivalent",
        reason:
          "the two versions can differ only where the character before a slash is a non-identifier that is NOT already regex-preceding -- which leaves `]` and `.` -- and in valid JavaScript the token before such a slash is an identifier, a numeric literal or a member name, never a reserved word, so the stale word and the empty one reach the same verdict",
      },
      {
        siteId: "statement-removal:442:7:inWord = false;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:468:9:inClass = false;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:494:9:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:502:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:511:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:883:30:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:814:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:913:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:964:21:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:820:40:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:921:40:1>2",
        kind: "equivalent",
        reason: "same opening-backtick argument for the shape (b) span ranges",
      },
      {
        siteId: "integer-literal:921:59:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId:
          "statement-removal:853:3:mismatches.sort((a, b) => a.first.docLine - b.first.docLine || a.first.column - b.first.column);>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:680:38:>=>>",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:680:41:0>1",
        kind: "equivalent",
        reason: "same argument as the loop bound beside it",
      },
      {
        siteId: "relational-boundary:687:74:<=><",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:997:61:<><=",
        kind: "equivalent",
        reason:
