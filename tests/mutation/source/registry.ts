...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "relational-boundary:2205:28:<><=",
        kind: "equivalent",
        reason:
