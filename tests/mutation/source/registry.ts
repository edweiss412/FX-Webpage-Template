...
export const GUARD_SURFACES: GuardSurface[] = [
  ...
  },
  {
    ...
    // Achieved 35/35 counted (57 mutants, 22 equivalent, NO accepted gap) after
    // the 2026-08-17 lexer-routing repair re-measured the surface; it was 30/30
    ...
    accepted: [
      ...
      // moves no state.
      {
        siteId: "relational-boundary:677:23:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:803:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:737:83:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1548:46:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1722:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1723:26:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1377:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1458:30:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1468:19:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1908:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1909:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1925:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1926:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2676:31:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2808:35:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2918:32:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1044:29:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2280:74:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2282:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2411:54:<><=",
        kind: "equivalent",
        reason:
