...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    operators: [...OPERATOR_NAMES],
    // Measured 1.00 over 11 counted mutants after the first enrolment run, so the
    // floor is measured-minus-0.05 rather than the 0.8 placeholder the row was
    // authored with: a floor below the shipped state cannot detect a regression
    // toward it. At 11 mutants one survivor scores 0.909, which trips 0.95 -- the
    // granularity is coarse enough that the floor catches a single lost kill.
    scoreFloor: 0.95,
      ...
      to: "if (!CORE_HEADS.has(head)) core.add(member.name.text);",
  {
    ...
    accepted: [
      ...
      // moves no state.
      {
        siteId: "relational-boundary:635:23:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:761:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:695:83:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1394:46:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1568:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1569:26:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1223:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1304:30:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1314:19:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1754:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1755:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1771:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1772:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "regex-quantifier-bound:2107:21:{1,2}>{1,3}",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2455:31:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2587:35:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2697:32:<><=",
        kind: "equivalent",
        reason:
