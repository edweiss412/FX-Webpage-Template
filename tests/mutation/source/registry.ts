...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      {
        siteId: "relational-boundary:955:29:>>>=",
        kind: "equivalent",
        reason:
          ...
          "(601 -> 721 -> 604 -> 603 -> 735 -> 748 -> 881 -> 890 -> 955). The expression and its 1-based column are byte-identical at " +
      ...
      {
        siteId: "relational-boundary:2701:28:<><=",
        kind: "equivalent",
        reason:
