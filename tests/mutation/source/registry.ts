...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      {
        siteId: "relational-boundary:890:29:>>>=",
        kind: "equivalent",
        reason:
          ...
          "(601 -> 721 -> 604 -> 603 -> 735 -> 748 -> 881 -> 890). The expression and its 1-based column are byte-identical at " +
      ...
      {
        siteId: "relational-boundary:2582:28:<><=",
        kind: "equivalent",
        reason:
