...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "relational-boundary:2256:28:<><=",
        kind: "equivalent",
        reason:
