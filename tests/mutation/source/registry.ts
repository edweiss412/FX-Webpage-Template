...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "relational-boundary:2207:28:<><=",
        kind: "equivalent",
        reason:
