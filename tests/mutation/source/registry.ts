...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      {
        siteId: "relational-boundary:748:29:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2433:28:<><=",
        kind: "equivalent",
        reason:
