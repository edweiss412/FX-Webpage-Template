...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "statement-removal:856:5:DIGIT_RUN_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in templateCandidates",
      },
      {
        siteId: "statement-removal:912:5:LEXICON.lastIndex = 0;>(removed)",
        kind: "equivalent",
      ...
      {
        siteId: "integer-literal:973:30:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:801:36:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:904:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1010:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1061:21:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:910:40:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:1018:40:1>2",
        kind: "equivalent",
        reason: "same opening-backtick argument for the shape (b) span ranges",
      },
      {
        siteId: "integer-literal:1018:59:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId:
          "statement-removal:943:3:mismatches.sort((a, b) => a.first.docLine - b.first.docLine || a.first.column - b.first.column);>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:877:24:0>1",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1094:61:<><=",
        kind: "equivalent",
        reason:
