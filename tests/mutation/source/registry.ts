...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "statement-removal:718:3:CARDINAL_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in cardinalsOn",
      },
      {
        siteId: "statement-removal:854:5:DIGIT_RUN_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in templateCandidates",
      },
      {
        siteId: "statement-removal:910:5:LEXICON.lastIndex = 0;>(removed)",
        kind: "equivalent",
      ...
      {
        siteId: "integer-literal:666:28:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:460:7:inWord = false;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:572:23:0>1",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:562:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:567:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:493:9:inClass = false;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:538:9:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:546:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "statement-removal:555:7:continue;>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:971:30:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:902:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1008:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1059:21:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:908:40:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:1016:40:1>2",
        kind: "equivalent",
        reason: "same opening-backtick argument for the shape (b) span ranges",
      },
      {
        siteId: "integer-literal:1016:59:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId:
          "statement-removal:941:3:mismatches.sort((a, b) => a.first.docLine - b.first.docLine || a.first.column - b.first.column);>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:737:38:>=>>",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:737:41:0>1",
        kind: "equivalent",
        reason: "same argument as the loop bound beside it",
      },
      {
        siteId: "relational-boundary:744:74:<=><",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1092:61:<><=",
        kind: "equivalent",
        reason:
