...
export const GUARD_SURFACES: GuardSurface[] = [
   ...
   */
  {
    ...
    accepted: [
      ...
      {
        siteId: "statement-removal:96:3:QUANTITY_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in quantityRanges",
      },
      {
        siteId: "statement-removal:114:3:DATED_QUALIFIER_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in qualifierBoundStarts",
      },
      {
        siteId: "statement-removal:260:3:CARDINAL_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in cardinalsOn",
      },
      {
        siteId: "statement-removal:369:5:DIGIT_RUN_RE.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in templateCandidates",
      },
      {
        siteId: "statement-removal:416:5:LEXICON.lastIndex = 0;>(removed)",
        kind: "equivalent",
        reason: "same exhaustion argument, in the hit scan",
      },
      // FAMILY 2 — inputs the accept-set cannot produce.
      {
        siteId: "integer-literal:114:34:0>1",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:408:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:502:25:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:551:21:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:414:40:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:510:40:1>2",
        kind: "equivalent",
        reason: "same opening-backtick argument for the shape (b) span ranges",
      },
      {
        siteId: "integer-literal:510:59:1>2",
        kind: "equivalent",
        reason:
      ...
      {
        siteId:
          "statement-removal:447:3:mismatches.sort((a, b) => a.first.docLine - b.first.docLine || a.first.column - b.first.column);>(removed)",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:279:38:>=>>",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "integer-literal:279:41:0>1",
        kind: "equivalent",
        reason: "same argument as the loop bound beside it",
      },
      {
        siteId: "relational-boundary:295:17:<=><",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:584:61:<><=",
        kind: "equivalent",
        reason:
