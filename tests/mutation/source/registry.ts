...
export const GUARD_SURFACES: GuardSurface[] = [
  ...
  },
  {
    ...
    accepted: [
      ...
      //
      // Both rows below are ONE argument applied twice. Their shared
      // invariant, and the single condition that voids both, is stated on
      // the first row rather than repeated.
      {
        siteId: "relational-boundary:1139:50:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2997:25:<><=",
        kind: "equivalent",
        reason:
          "The SAME invariant, applied to a redirection and the target that FOLLOWS it. The word route skips a target lying BEFORE the effective redirection; the widened bound would additionally skip one lying exactly AT it. A detached target is a separate word emitted only after the operator's characters are consumed, so `target.offset >= effective.offset + effective.operator.length` and equality would require the target to begin at the operator's own first character. WHY THE EARLIER RUNGS DO NOT APPLY: deletion CHANGES BEHAVIOUR - without this comparison `read -r PG <<< notpsql <<< psql` reads the overridden first target and the pin below fails, so removing the site would buy a metric point with correctness. Boundary pin: `the LAST here-string is the psql one`, the case that requires this comparison to exist at all.",
      },
      {
        siteId: "relational-boundary:1391:29:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2016:46:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1845:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2191:26:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2190:22:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1926:30:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:1936:19:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2382:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2383:12:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2399:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2400:16:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "regex-quantifier-bound:2903:21:{1,2}>{1,3}",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:3111:54:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:3413:31:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:3545:35:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:3655:32:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2969:29:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2854:72:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2856:20:>>>=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2924:52:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2800:24:<><=",
        kind: "equivalent",
        reason:
      ...
      {
        siteId: "relational-boundary:2807:22:>>>=",
        kind: "equivalent",
        reason:
