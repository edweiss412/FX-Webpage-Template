 ...
 * synthetic badge), step3-review-modal.layout (review-modal redesign Task 10
 * — §5.1 dimensional invariants + §15 tap targets on the REAL component tree),
 * step3-review-modal.interactions (Task 11 — LIVE esbuild-bundled tree: §10
 * drag, §6.3a scroll-spy, §16 Tab audit).
 */
export default defineConfig({
  testDir: ".",
  testMatch:
    /(step3-card-dimensions|step3-grid-layout|step3-schedule-bookend-layout|agendaScheduleLayout|agendaBreakdown\.layout|step3-review-modal\.layout|step3-review-modal\.interactions|developer-toggle-layout|appHealthIndicator\.layout)\.spec\.ts/,
  timeout: 120_000,
  fullyParallel: false,
  workers: 1,
  reporter: "list",
