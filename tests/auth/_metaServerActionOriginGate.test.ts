...
const PENDING_GATE: readonly string[] = [
  ...
  "app/admin/settings/_actions/setAlertOnAutoPublish.ts",
  "app/admin/settings/_actions/setAlertOnSyncProblems.ts",
  "app/admin/settings/_actions/setAutoPublish.ts",
  "app/admin/settings/_actions/setDailyReviewDigest.ts",
  "app/admin/settings/_actions/validationReset.ts",
  "app/admin/settings/admins/actions.ts",
  "app/admin/settings/admins/developerActions.ts",
