 ...
 *
 * Run: pnpm exec tsx tests/cross-cutting/redirect-guard-probes/red-harness.mjs
 */
...
const ROWS = [
  ...
  [
    "R28 class-field structural property",
    PRE +
  ...
  [
    "R36 as-any VALUE laundering (EXPECT CAUGHT)",
    PRE +
