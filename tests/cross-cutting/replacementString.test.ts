...
const EXPECTED_OFFENDERS: readonly string[] = [
  ...
  "scripts/intraleg-killer-audit.mjs:767",
  "scripts/share-link-flash-adversary-matrix.mjs:876",
  ...
  "tests/cross-cutting/pgCronCiVacuity.test.ts:202",
  ...
  "tests/db/connectionCensus.test.ts:1690",
  ...
  "tests/docs/agentsHeavyPhaseRule.test.ts:826",
