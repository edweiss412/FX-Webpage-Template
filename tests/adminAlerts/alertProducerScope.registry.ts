...
export const PRODUCER_SCOPE: ProducerScopeRow[] = [
  ...
  },
  {
    ...
    scope: "per-show",
    note: "context built by buildParseErrorContext(lib/sync/runManualSyncForShow.ts:261); keys mirror the cron twin at lib/sync/runScheduledCronSync.ts:3645",
  },
  {
  ...
  {
    site: "lib/sync/runScheduledCronSync.ts:2472",
    contextKeys: [
      "crew_count",
      "drive_file_id",
      "sheet_name",
  ...
  {
    site: "lib/sync/runScheduledCronSync.ts:2684",
    contextKeys: ["drive_file_id", "previous_last_seen_modified_time", "sheet_name"],
    code: "SHEET_UNAVAILABLE",
    scope: "per-show",
  },
  {
    ...
    site: "lib/sync/runScheduledCronSync.ts:2768",
    computedContext: true,
    contextKeys: ["drive_file_id", "sheet_name"],
    // error_code is spread-conditional on the failure code being allowlisted
    // (lib/sync/parseErrorContext.ts:16-23), so it is optional, not guaranteed.
  ...
  {
    site: "lib/sync/runScheduledCronSync.ts:2805",
    contextKeys: [
      "drive_file_id",
      "failure_code",
      "previous_last_seen_modified_time",
  ...
  {
    site: "lib/sync/runScheduledCronSync.ts:2824",
    contextKeys: [
      "drive_file_id",
      "failure_code",
      "previous_last_seen_modified_time",
  ...
  },
  {
    ...
    code: "PARSE_ERROR_LAST_GOOD",
    scope: "per-show",
    note: "context built by buildParseErrorContext(lib/sync/runScheduledCronSync.ts:3645)",
  },
  {
    site: "lib/sync/runScheduledCronSync.ts:3677",
