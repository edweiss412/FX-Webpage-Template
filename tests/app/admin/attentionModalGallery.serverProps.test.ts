...
// Then eleven more from the type-aware recognizer
// (docs/superpowers/specs/2026-08-03-parse-warning-code-recognizer-design.md §4.1):
// the five DIAGRAMS_*, EMBEDDED_ASSET_DRIFTED, LINKED_FOLDER_OVERFLOW_TRUNCATED and
// the three reel codes were emitters the old directory scan never opened, and
// EMBEDDED_RECOVERY_REQUIRES_RESTAGE was masked by a sibling literal call site
// (spec §2.6). Each already had a §12.4 catalog row; only the gallery could not see them.
