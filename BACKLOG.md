...
## BL-MI9-LEAD-ROUTING-DIVERGENCE — auth-sensitive LEAD-bit change auto-applies instead of staging (canonical spec violation)

**Status:** OPEN (2026-07-17, surfaced by REDESIGN-3 adversarial review R13/R21) · **Severity:** HIGH (security / authorization) · **Class:** AUTH ROUTING REGRESSION
