...
**Status:** OPEN (2026-07-17, consolidated-admin-show-page share-serialization fix) · **Severity:** low (pre-existing; admin-gated; defense-in-depth) · **Class:** DB SECURITY / RPC LIFECYCLE GUARD
