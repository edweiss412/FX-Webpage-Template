...
| ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| route all section-header detection through a shared, introspectable constant/helper            | per-file `SECTION_HEADER_TOKENS` exports plus the shared factory `lib/parser/blocks/_sectionHeaderMatch.ts` (8 importers under `lib/parser/blocks/`, plus `lib/parser/index.ts`) |
