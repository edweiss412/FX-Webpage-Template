...
**Design + acceptance:** `docs/superpowers/specs/crew/2026-08-09-crew-wifi-room-enrichment-design.md` (§6 carries the documented limits — seven at merge, including the two suppression rules that will look like bugs to anyone who has not read them, and the flattened-trailing-prose limit added during whole-diff review). Recorded by feat/crew-field-enrichment.
