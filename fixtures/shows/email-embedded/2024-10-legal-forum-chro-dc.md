...
- Date: 2024-10-04
- Subject: Details for II Legal Forum / USI Chief Human Resource Officer - Four Seasons - Washington DC - 10/6 - 10/10
- Note: Original sheet (id 1VpMtMTBzmE63ORWAuY5ZTPqnGuaDeLtTfZ3SYrm_CjM) is no longer accessible. This fixture is the show details Doug embedded directly in the email body.

---

Hey guys,

Here are the details for this Institutional Investor event in Washington DC coming up this Monday, Oct 7th at 8:00am at the Four Seasons.

CJ will be delivering this in a 26' box truck rental (because Eric Carroll also has a show at the Westin in Wash DC).

This is our standard "small" setup with (2) sections of grey spandex and (1) section of dark blue Logo Spandex.

The ceiling in Dumbarton is low!! - 9' 2". So you have (2) short 2.0 uprights with (1) 2.0 crossbar FOR THE LOGO SPANDEX.

We've packed (4) regular uprights with (2) regular crosses (with tech inserts to make them shorter) for the other 2 sections of grey spandex.

Please make sure to GAFF TAPE the tops of the uprights and crosses so it does not rip the spandex!

Here is the link to the spreadsheet that has the information below along with diagrams, agenda and pull sheet:
https://docs.google.com/spreadsheets/d/1VpMtMTBzmE63ORWAuY5ZTPqnGuaDeLtTfZ3SYrm_CjM/edit?usp=sharing

Dean and Jhai are staying on property - Eric Weiss will be around the corner at "Sonder Hotel".

Let me know you got this and if you have any questions.
...
Hotel Contact Info
Falencia Normeus
falencia.normeus@fourseasons.com
...
GS Lighting
(1) Litetronics Lightboard
(2) Lekos
(6) Rockville Uplights
(1) 10' Steel Pipe
(1) 2' Steel Extensions
(1) Steel Bases
(4) Sandbags

GS Other
(1) Section Printed Logo Spandex
