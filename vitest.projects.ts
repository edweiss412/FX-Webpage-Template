...
// verifying the dir is DB-free. PHASE 3 CONTRACT: the remaining mixed dirs
// (tests/db, tests/sync, tests/onboarding, tests/admin, …) are deliberately NOT
// parallel globs, so a NEW test file added to any of them lands in SERIAL
// automatically — safe by default. A file becomes parallel only via an explicit,
// reviewable entry in PARALLEL_EXTRA_FILES, regenerated by the procedure in
// docs/superpowers/specs/ci/2026-07-20-ci-unit-suite-phase3-file-granular-serial.md
// §3.4 (automation tracked by BL-CI-SERIAL-AUDIT-SCRIPT).
