...
export type PreviousCrewMember = CrewMemberRow & {
  ...
  // §3.6: carried on the snapshot so the id-keyed crew reconciliation has the complete live-row
  // lifecycle set. Preserved (never overwritten) by the id-keyed UPDATE, alongside claimed_via_oauth_at.
