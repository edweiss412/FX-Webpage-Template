...
**Examined:** 18 counted rounds (R2–R19) across two scopes, scanner-logic and registry-fidelity, declaring 48 findings; 3 dispatches returned no verdict and are not counted. The registry-fidelity scope APPROVED at R6 with 0 findings and was not dispatched again. Every finding was probed by the reviewer against the shipped guard, and every accepted one was repaired with a planted self-test plus a mutant proving the repair load-bearing — 51 mutants killed, one proven equivalent.
