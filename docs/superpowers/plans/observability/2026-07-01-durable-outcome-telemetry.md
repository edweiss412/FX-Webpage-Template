...
> **For agentic workers:** TDD per task (failing test → minimal impl → passing test → commit). Steps use `- [ ]`. Spec: `docs/superpowers/specs/observability/2026-07-01-durable-outcome-telemetry-design.md`.
