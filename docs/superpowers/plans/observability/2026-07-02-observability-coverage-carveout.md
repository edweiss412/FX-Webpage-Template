...
**Spec:** `docs/superpowers/specs/observability/2026-07-02-observability-coverage-carveout-design.md` (Codex-APPROVED, 3 rounds). Every anchor below is verified against live code in this worktree.
