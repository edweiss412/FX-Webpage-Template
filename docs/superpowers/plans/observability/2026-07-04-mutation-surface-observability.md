...
- **Spec is canonical:** `docs/superpowers/specs/observability/2026-07-04-mutation-surface-observability.md` (APPROVED, 20 adversarial rounds). Every task implements a spec section; cite it.
