...
- **Spec is canonical:** `docs/superpowers/specs/observability/2026-07-01-watch-channel-health-design.md` (Status: APPROVED, 11 adversarial rounds). Read the section cited by each task before implementing it. Where this plan and the spec disagree, the spec wins.
