...
- **AC-7** (spec §6 AC-7): §5.4 transition pins per the family matrix (family A at three sites; family B at all four), each shown red against both applicable migration mutants.
