...
- Modify: `lib/parser/blocks/transport.ts` (V2_SCHEDULE_LABELS membership, lib/parser/blocks/transport.ts:108)
...
<!-- task: red=`pnpm exec vitest run tests/parser/fieldNearMissBaseline.test.ts tests/parser/venueSwapInvariance.test.ts` ac=AC-N1,AC-N2,AC-N3,AC-N5,AC-N8,AC-N9 -->
...
<!-- task: red=`pnpm heavy pnpm test` ac=AC-N1,AC-N2,AC-N3,AC-N4,AC-N5,AC-N6,AC-N7 -->
