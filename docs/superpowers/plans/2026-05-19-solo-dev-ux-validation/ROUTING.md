...
| 0.D — Mint-link / revoke-link scripts | Opus / Claude Code | Codex — cross-CLI adversarial review | Auth-adjacent tooling; same routing as `lib/auth/` work. |
...
**Plan tree implementer** (the M12 plan itself, i.e., this directory): Opus / Claude Code (M12 spec is at `docs/superpowers/specs/2026-05-19-solo-dev-ux-validation-design.md`; plan derives from it; the spec went through 25 rounds of cross-CLI review).
