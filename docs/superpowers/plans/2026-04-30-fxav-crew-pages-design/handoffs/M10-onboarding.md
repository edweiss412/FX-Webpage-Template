...
- **DEFERRED.md status:**
  ...
  - **M10-D-PHASE3-1** (NEW, this Phase 3 §B convergence): `/api/report` auth precedence — admin preview reports downgrade to crew when both sessions are valid. §A-OWNED route fix per AGENTS.md §1.8.
