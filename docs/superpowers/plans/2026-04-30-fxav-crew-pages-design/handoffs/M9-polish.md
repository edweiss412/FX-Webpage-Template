...
4. **Whole-M9 cross-model adversarial review** ran across seven rounds:
   ...
   - **R7** (`07fa01d` + this commit): HIGH final close-out undercounted M9-D-C6c-1 (declined HIGH from C6c critique) + MEDIUM chronology stale. Fixed: this updated section + tracked-residuals count corrected to 2.
