...
| R9 | needs-attention | M1-r9 §12 R8 row still '(in flight)'; M2-r9 SHEET_UNAVAILABLE.followUp drift from spec | (in progress) | Two narrow MEDIUM cleanups — handoff SHA backfill and a single followUp string. No functional regressions. |
