...
**Goal:** Render one per-code "go to X" action link in admin alert rows, driven by a typed registry, per spec `docs/superpowers/specs/alerts/2026-07-04-alert-action-links.md`.
...
- Spec is canonical: `docs/superpowers/specs/alerts/2026-07-04-alert-action-links.md`. §4 is the exact 9-entry registry table; §5 is the N/A coverage; §7.3 is the guard table.
...
2. **Handoff doc:** write `docs/superpowers/plans/alerts/2026-07-04-alert-action-links/handoff.md` recording the task→commit map, test evidence (suite counts), the meta-test's negative-verification result (Task 1 step 6), and a §12 placeholder for impeccable dispositions. Commit as `docs(handoff): alert-action-links implementation handoff`.
