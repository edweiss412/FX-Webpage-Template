...
- **Spec is canonical:** `docs/superpowers/specs/alerts/2026-07-03-route-sync-problems-to-needs-attention.md`. Where this plan references a spec section, the spec's detail governs.
