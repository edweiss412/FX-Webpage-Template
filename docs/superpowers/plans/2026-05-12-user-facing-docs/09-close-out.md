...
- **OR explicitly defer via `DEFERRED.md`** (matching the existing crew-pages plan's `DEFERRED.md` pattern at `docs/superpowers/plans/2026-04-30-fxav-crew-pages-design/DEFERRED.md`). For M11, the canonical deferral file path is `docs/superpowers/plans/2026-05-12-user-facing-docs/DEFERRED.md` (mirror the crew-pages pattern under the M11 plan directory). Acceptable for findings that are real but better-scoped to a follow-up milestone.
...
```bash
git add docs/superpowers/plans/2026-05-12-user-facing-docs/handoffs/M11-help.md docs/superpowers/plans/2026-05-12-user-facing-docs/DEFERRED.md
...
```bash
git add docs/superpowers/plans/2026-05-12-user-facing-docs/handoffs/M11-help.md
...
**Files:**
- Create or finalize: `docs/superpowers/plans/2026-05-12-user-facing-docs/handoffs/M11-help.md`

The handoff doc is the canonical record of M11's execution. Mirror the existing handoff pattern at `docs/superpowers/plans/2026-04-30-fxav-crew-pages-design/handoffs/`.
...
```bash
git add docs/superpowers/plans/2026-05-12-user-facing-docs/handoffs/M11-help.md docs/superpowers/plans/2026-04-30-fxav-crew-pages-design/ROUTING.md
