...
Feature branch: `feat/admin-alert-auto-resolution` · Spec: `docs/superpowers/specs/2026-07-03-admin-alert-auto-resolution.md` (Codex APPROVE R7) · Plan: `plan.md` in this dir (Codex APPROVE R8).
