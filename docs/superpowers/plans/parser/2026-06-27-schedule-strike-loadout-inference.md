...
**Spec:** `docs/superpowers/specs/parser/2026-06-27-schedule-strike-loadout-inference-design.md` (APPROVED, 17 adversarial rounds). Cite it for rationale; this plan carries the code.
