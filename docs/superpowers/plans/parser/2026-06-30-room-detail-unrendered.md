...
**Tech Stack:** Next.js Server Components, TypeScript, Vitest + Testing Library. Spec: `docs/superpowers/specs/parser/2026-06-30-room-detail-unrendered-design.md` (Codex-APPROVED, round 1).
