...
Deferred (filed): `DEF-FLIGHT-1` (TRAVEL-tab flight parser) in `docs/superpowers/plans/parser/2026-06-19-crew-flight-info/DEFERRED.md`; `BL-CREW-PII-DB-LOCKDOWN` (crew-PII DB hardening) in `BACKLOG.md`.
