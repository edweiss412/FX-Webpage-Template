...
**Spec:** `docs/superpowers/specs/parser/2026-07-02-diagrams-embedded-images.md` (Codex-APPROVED, 3 rounds). Every task below implements a part of it; the spec's citation appendix (§16) is the authoritative `file:line` map.
