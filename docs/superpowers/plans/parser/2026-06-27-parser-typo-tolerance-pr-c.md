...
**Spec:** `docs/superpowers/specs/parser/2026-06-27-parser-typo-tolerance-design.md` §5.3 (Codex-APPROVED 2R). The 6-agent surface map (this milestone) determined ops is the ONLY clean re-route; rooms/transport/client/dates → PR-D, event/diagrams → do-not-fuzz.
