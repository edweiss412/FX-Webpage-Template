...
**Tech Stack:** TypeScript, Vitest, Postgres/Supabase, Next 16, Tailwind v4. Spec: `docs/superpowers/specs/parser/2026-06-30-transport-loadout-contact-design.md` (Codex-APPROVED round 2).
