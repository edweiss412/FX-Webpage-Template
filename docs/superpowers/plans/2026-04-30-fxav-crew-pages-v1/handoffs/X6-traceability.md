...
- **M9 C9 / `docs/superpowers/specs/amendments/` convention** — the spec amendments directory is one of two amendment landing sites (the other being inline spec edits). The traceability walker MUST recognize amendments at both locations (inline in `2026-04-30-fxav-crew-pages-v1.md` AND files under `docs/superpowers/specs/amendments/`). Pre-existing files: `2026-05-12-catalog-agenda-codes.md`, `2026-05-14-admin-allowlist-runtime-mutable.md`.
