...
**Plan file:** `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/05-auth.md` (Tasks 5.1–5.11; lines 1–411).
...
Verbatim from spec §17.1 (`docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md:3381-3400`). Every AC ID has at least one §A-side or §B-side test.
