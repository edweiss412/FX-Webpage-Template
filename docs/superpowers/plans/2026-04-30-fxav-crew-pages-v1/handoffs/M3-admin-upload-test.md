...
**Plan file:** `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/03-04-tiles.md` (Tasks 3.1–3.2 only — lines 7–171; M4 starts at line 175 and is **out of scope** for this milestone)
...
- §17.1 — Per-milestone acceptance criteria (M3 entry, including the round-46 retirement of "no auth" framing). AC-3.1, AC-3.2, AC-3.3 are defined here at `docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md:3360–3362`.
