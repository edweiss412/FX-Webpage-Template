...
**Plan file:** `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/03-04-tiles.md` (Tasks 4.1–4.16; lines 175–836). Tasks 3.1–3.2 are M3 — closed, out of scope.
...
Verbatim from spec §17.1 (`docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md:3366-3377`):
