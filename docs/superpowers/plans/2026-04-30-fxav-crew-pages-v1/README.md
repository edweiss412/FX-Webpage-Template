...
**Spec:** [`docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md`](../../specs/2026-04-30-fxav-crew-pages-v1.md)
...
```sh
grep -rn "Task 6.7" docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/
```

Spec section references (`§5.2`, `§7.2.2`, etc.) point into the single-file spec at `docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md` — that file was **not** split and remains the canonical spec.
