...
**How to use:** Copy the template below into a new file at `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/handoffs/M<n>-<short-name>.md` (create the `handoffs/` subdir on first use). Fill every field. If a field is "N/A" say so explicitly — empty fields silently lie.
...
**Plan file:** `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/<file>.md`
