...
**Spec:** `docs/superpowers/specs/2026-07-03-observability-coverage-pr2-design.md` (Codex-APPROVE'd, 4 rounds) — the file:line-precise source of truth for every surface. This plan is the task/test decomposition; consult the spec for each surface's exact codes + placement.
