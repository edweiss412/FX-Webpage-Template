...
- **Close-out deferral home:** `docs/superpowers/plans/crew/2026-06-15-crew-page-redesign-phase2/DEFERRED.md` (create if absent — follows the per-plan `DEFERRED.md` convention, e.g. `docs/superpowers/plans/2026-04-30-fxav-crew-pages-v1/DEFERRED.md`).
...
- [ ] HIGH + CRITICAL findings either FIXED (commit `fix(crew-page): <what>` per TDD — new test first) OR explicitly DEFERRED via a `docs/superpowers/plans/crew/2026-06-15-crew-page-redesign-phase2/DEFERRED.md` entry (concrete trigger, not "later").
