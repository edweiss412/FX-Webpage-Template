...
**Tech Stack:** Next.js Server Components, TypeScript, Vitest + Testing Library. Spec: `docs/superpowers/specs/crew/2026-06-30-crew-partial-attendance-chip-design.md` (Codex-APPROVED round 2).
