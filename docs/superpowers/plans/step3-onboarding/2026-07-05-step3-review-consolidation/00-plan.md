...
**Spec:** `docs/superpowers/specs/step3-onboarding/2026-07-05-step3-review-consolidation.md` (adversarial-approved R11). Every task cites the spec section it implements.
