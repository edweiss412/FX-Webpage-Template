...
**Spec basis (canonical — feature was deferred CODE, not a new design):** §6.1 (spec:132-134), affordance §7.7 (spec:230-235), AC11 (spec:304) in `docs/superpowers/specs/step3-onboarding/2026-06-23-onboarding-step3-review-redesign.md`. Lifts DEFERRED.md DS3-1 (DEFERRED.md:70-79).
