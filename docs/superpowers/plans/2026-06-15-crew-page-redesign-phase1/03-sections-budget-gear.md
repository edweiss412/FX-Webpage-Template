...
- [ ] **Step 4: run to pass.** **Step 5: `pnpm tsc --noEmit`.** **Step 6: commit** `feat(crew-page): active-section tileErrors visual fallback (admin degraded / crew omission, no second alert)`.
