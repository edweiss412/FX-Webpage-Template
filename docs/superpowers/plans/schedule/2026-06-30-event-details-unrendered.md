...
**Tech Stack:** Next.js Server Components, TypeScript, Vitest + Testing Library. Spec: `docs/superpowers/specs/schedule/2026-06-30-event-details-unrendered-design.md` (Codex-APPROVED).
