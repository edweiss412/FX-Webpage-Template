...
**Spec:** `docs/superpowers/specs/schedule/2026-06-26-agenda-pdf-schedule-design.md` (Codex-APPROVED). Every contract below is from that spec; section refs (§) point into it.
