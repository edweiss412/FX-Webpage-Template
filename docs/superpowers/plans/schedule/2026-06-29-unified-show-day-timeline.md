...
**Tech Stack:** Next.js 16 RSC, React, TypeScript, Vitest + Testing Library (jsdom), Playwright (real-browser layout). Spec: `docs/superpowers/specs/schedule/2026-06-29-unified-show-day-timeline-design.md` (Codex-APPROVED, 4 rounds).
