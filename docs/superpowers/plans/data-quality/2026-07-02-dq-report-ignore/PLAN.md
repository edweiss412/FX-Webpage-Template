...
**Spec:** `docs/superpowers/specs/data-quality/2026-07-02-dq-report-ignore.md` (Codex-approved). Every task's requirements implicitly include the spec + Global Constraints below.
