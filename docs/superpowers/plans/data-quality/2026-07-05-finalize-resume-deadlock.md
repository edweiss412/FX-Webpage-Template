...
**Spec:** `docs/superpowers/specs/data-quality/2026-07-05-finalize-resume-deadlock.md` is the canonical, adversarially-reviewed (10 rounds) contract. Every task below implements a section of it; where a task says "per spec §X", the spec carries the full contract and MUST be honored exactly.
