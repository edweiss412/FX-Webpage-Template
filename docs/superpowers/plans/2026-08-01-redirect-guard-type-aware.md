...
**Spec:** `docs/superpowers/specs/2026-08-01-redirect-guard-type-aware-design.md` (R5 — rounds 1–3 + whole-diff r2 repaired; §1.1 do-not-relitigate, §2 probe data, §6 mutation-family closure set). **Branch:** `test/redirect-guard-type-aware`.
