...
**Spec:** `docs/superpowers/specs/2026-07-04-alert-resolve-truthing.md` (APPROVED, 3 Codex rounds).
**Plan:** `docs/superpowers/plans/2026-07-04-alert-resolve-truthing/plan.md` (APPROVED, 6 Codex rounds).
