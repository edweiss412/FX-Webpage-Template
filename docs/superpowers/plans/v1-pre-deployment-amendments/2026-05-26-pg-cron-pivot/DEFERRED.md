...
- The orphaned `cleanup-bootstrap-nonces` cron scheduled by `supabase/migrations/20260504000001_bootstrap_nonces_signing_key.sql:36` is IN scope for M12.1 (R25 F49 + R26 F51): T3 unschedules it as a side-effect cleanup. Any OTHER bootstrap-nonces / signing-key-rotation work (re-implementing nonce cleanup, schedule replacement, key-rotation cadence) is OUT of M12.1 scope — file in BACKLOG.md.
