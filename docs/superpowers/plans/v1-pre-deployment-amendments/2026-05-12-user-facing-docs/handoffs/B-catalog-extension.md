...
**Plan file:** `docs/superpowers/plans/v1-pre-deployment-amendments/2026-05-12-user-facing-docs/02-catalog-extension.md` (Tasks B.1–B.5; r3-reordered so B.2 parser lands before B.3 alignment).
...
- **Plan version:** `docs/superpowers/plans/v1-pre-deployment-amendments/2026-05-12-user-facing-docs/02-catalog-extension.md` r3 (commit `977dc78` — M12 → M11 rename + plan reordering, 2026-05-19).
- **Spec version:** `docs/superpowers/specs/v1-pre-deployment-amendments/2026-05-12-user-facing-docs-design.md` r14 (commit `977dc78`). Phase B implements spec §5.1 schema extension + §7.1 tests #2 and #17 + AC-11.5 / AC-11.6 / AC-11.11 / AC-11.35.
