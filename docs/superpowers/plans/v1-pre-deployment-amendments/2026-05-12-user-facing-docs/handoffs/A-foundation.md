...
**Plan file:** `docs/superpowers/plans/v1-pre-deployment-amendments/2026-05-12-user-facing-docs/01-foundation.md` (Tasks A.1–A.7).
...
- **Plan version:** `docs/superpowers/plans/v1-pre-deployment-amendments/2026-05-12-user-facing-docs/` r1 (commit `977dc78` — rename M12 → M11 + retire fictional M11 ops-hardening slot, 2026-05-19).
- **Spec version:** `docs/superpowers/specs/v1-pre-deployment-amendments/2026-05-12-user-facing-docs-design.md` r14 (current HEAD). Spec amendments through 2026-05-19 confirmed integrated in §12.4 (per X.1 close-out at `2090dc2`). Phase A consumes the catalog read-only; Phase B (subsequent) extends the schema.
...
| AC-11.22 | PASS (sequencing) | M10 closed at SHA `9b34d30` per `../2026-04-30-fxav-crew-pages-v1/handoffs/M10-onboarding.md:1`. Phase A starts post-M10. |
