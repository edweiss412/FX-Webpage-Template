...
describe("validation_state", () => {
  ...
  test("ALTER COLUMN DROP NOT NULL drift-repair applied via migration artifact (R59 F50, R61 F52 strengthened)", () => {
