...
| **B2** | Show lifecycle — archive/unarchive + Held state + Publish + auto-publish-clean toggle + 5 archived-immutability guards (DEF-1/2/3 + cron/push/missing-file + pending-ingestion routes) | `…/specs/v1-pre-deployment-amendments/2026-06-01-m12.2-phase-b2-show-lifecycle-design.md` ✅ APPROVED (Codex 31 rounds + owner sign-off, 2026-06-01; plan amendment 12 RATIFIED) | `./M12.2-phase-b2-show-lifecycle.md` ✅ APPROVED (Codex 3 rounds, 2026-06-01); handoff `./handoffs/M12.2-phase-b2-show-lifecycle.md` | ✅ spec + plan APPROVED → execution (split: Codex backend / Opus UI) |
