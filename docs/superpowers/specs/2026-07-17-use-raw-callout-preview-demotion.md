...
- `UseRawControlBoundary` self-hides unless the warning is an in-scope structural-transform code (e.g. `roomSplitWarning` → `ROOM_HEADER_SPLIT_AMBIGUOUS`, fixture `:395`).
