...
| Gate caller (only) | `lib/sync/runScheduledCronSync.ts:299-359` | `evaluateQualityRegression_unlocked`. Guard L309 `if (!showId || priorParseWarningsRaw === null) return; // not published`. Calls `isQualityRegression` L327, `hasRecoveredToBaseline` L336, `buildRegressionPayload` L259/331/341. |
