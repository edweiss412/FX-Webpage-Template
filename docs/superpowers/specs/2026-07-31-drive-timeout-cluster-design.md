...
<!-- spec-lint: not-ui — the only component citation (Step2Verify.tsx) documents the EXISTING catalog render path for the new error code; no UI file changes in this diff (invariant-8 N/A, §5) -->


**Date:** 2026-07-31 · **Branch:** `fix/drive-api-call-timeouts` · **Mode:** autonomous ship (consent via `/ship-feature`) · **Revision:** R3 (post adversarial rounds 1–2 — all eight findings addressed; probe transcripts inline)
