...
| Bell tests (`bellPanelRedesign.test.tsx:220-291`) | Caret tests rewritten: caret = nav link present iff slug; expansion tests deleted; orphan-check invariant replaced (all admin codes now null helpfulContext by contract). |
