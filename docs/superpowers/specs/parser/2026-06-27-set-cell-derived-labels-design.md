...
**Resolves:** `DEFERRED.md` **D-SET1** ("Rich multi-entry SET run-of-show (cell-derived titles)"), itself deferred from `docs/superpowers/specs/parser/2026-06-27-schedule-strike-loadout-inference-design.md` §6 (rounds R9/R11/R12/R13/R14).
