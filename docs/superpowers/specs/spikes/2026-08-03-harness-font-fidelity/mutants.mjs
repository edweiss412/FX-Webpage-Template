...
const MUTANTS = {
  ...
  "R29a @supports family override": c => c + "\n@supports (display: grid) { html { font-family: Arial; } }\n",
  "R29b @container family override": c => c + "\n@container (min-width: 10px) { html { font-family: Arial; } }\n",
  "R29c dark-mode redefines --font-sans (indirect)": c => c + "\n@media (prefers-color-scheme: dark) { :root { --font-sans: Arial; } }\n",
