...
**Supersedes (partial):** `docs/superpowers/specs/alerts/2026-07-03-admin-alert-auto-resolution.md` §3 — the `GITHUB_BOT_LOGIN_MISSING` `DEFER` row only (the two `BRANCH_PROTECTION_*` `DEFER` rows are retained; see §6.3, §7).
...
- **`docs/superpowers/specs/alerts/2026-07-03-admin-alert-auto-resolution.md`:** update §3 (the
