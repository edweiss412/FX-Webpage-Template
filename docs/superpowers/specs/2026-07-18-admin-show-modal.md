...
API: `{ open: boolean; onClose(): void; labelledBy: string; dataAttrPrefix: "step3-review" | "review-modal"; testIdBase: string; initialFocusRef: RefObject<HTMLElement | null>; header: ReactNode; children: ReactNode; footer?: ReactNode }`.
