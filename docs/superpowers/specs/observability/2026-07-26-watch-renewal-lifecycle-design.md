...
| A zero-row activation throws and lands in the orphan-and-alert path, raising `WATCH_CHANNEL_ORPHANED` | The other retained mechanism, and today's silent-success bug. Assert the ALERT, not just the throw. |
