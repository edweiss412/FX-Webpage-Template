...
The limit is recorded in three places, with the live 719 / 79 / 70 / 9 numbers, the 3-site judgement marked as a judgement, and the re-file trigger at its computable value of 7: at the arm in `_renderFaultScan.ts`, in the residue registry's docblock, and in §8.5 of `docs/superpowers/specs/ci/2026-08-22-screenshots-drift-degraded-render-design.md`.
