...
PRESENT = [
    ...
    ("plan: 7 is not a 6 mirror",     [PLAN],   "IT IS NOT A MIRROR OF SPEC §6"),
    ...
    ("2.0 second motivating instance",[SPEC],   "A SECOND MOTIVATING INSTANCE"),
    ("handoff: stamp could not run",  [HANDOFF],"COULD NOT RUN AT ALL"),
...
ABSENT = [
    ...
    ("retired: 7 mirrors 6 claim",             [PLAN],        "and every row of spec §6, has a row\nhere"),
