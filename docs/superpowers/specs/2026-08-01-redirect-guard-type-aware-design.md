...
**Status:** R11 — whole-diff round-8 repaired; threat-model boundary ratified · **Branch:** `test/redirect-guard-type-aware` · **Date:** 2026-08-01
...
2. Updated `tests/cross-cutting/no-absolute-self-redirect.test.ts` (compilable fixtures; R20–R92, N1–N12, E1; memoized tree `describe` with JS sentinel and vacuous-walk floors).
