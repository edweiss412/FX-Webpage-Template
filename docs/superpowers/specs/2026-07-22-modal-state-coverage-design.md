...
export type ScenarioFixture = {
  ...
  // token is provider-level, not a modal prop); crewEmails generates N distinct
  // fixture emails as the modal's `crewEmails` prop. With enough emails the
  // mailto hrefs exceed MAX_MAILTO_HREF_CHARS (1900, app/admin/show/[slug]/crewLinkMailto.ts:12)
  // and ShareHub renders the multi-batch note + numbered email actions
  // (components/admin/showpage/ShareHub.tsx:442-451).
