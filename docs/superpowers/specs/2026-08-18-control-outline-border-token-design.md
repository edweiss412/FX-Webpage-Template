...
- **Applied to the ORIGINAL 21 as well as the 36 additions** (57 rows in total). Probed: exactly one of the 21 fails it today (`app/admin/show/[slug]/ResetPickerEpochButton.tsx:178`), and that failure is the intended repair. No other row regresses.
