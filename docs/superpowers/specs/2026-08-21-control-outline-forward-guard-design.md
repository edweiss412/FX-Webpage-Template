...
4. **Negative controls are expect-a-report.** The six mutation cases of AC-2 and the seven bar cases of AC-4 each assert a produced value by equality. No case in the suite passes because something was absent.
