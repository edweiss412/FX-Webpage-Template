...
| ignored mount (`mode="ignored"`): controls present, `showControlsNote` absent | guidance alone; `Un-ignore` never sits beside a sentence saying `Ignore` |
