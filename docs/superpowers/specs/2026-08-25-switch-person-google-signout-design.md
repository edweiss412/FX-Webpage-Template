...
- Invariant 5: the only user-visible failure copy is the existing `PICKER_SWITCH_FAILED` row via `messageFor` (`AvatarMenu.tsx:549-557`). No raw code reaches UI.
