...
For implementation-level specs (data model, auth chain, sync architecture), see [`docs/superpowers/specs/2026-04-30-fxav-crew-pages-v1.md`](./superpowers/specs/2026-04-30-fxav-crew-pages-v1.md). This document only covers the _visual and experiential_ decisions.
